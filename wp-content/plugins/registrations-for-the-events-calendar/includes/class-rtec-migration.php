...
class RTEC_Migration {
	...
	public function migration_needed_alert() {
		...
		<div class="rtec-notice rtec-top-notice rtec-box-shadow">
			...
			printf( __( 'Migration needed for some registrations! No action needed as this is being done automatically. Visit %1$sthis page%2$s if you would like to review progress.', 'registrations-for-the-events-calendar' ), '<a href="' . esc_url( admin_url( 'admin.php?page=rtec-settings&tab=migration' ) ) . '">', '</a>' ); ?>
		</div>
		<?php
	}
