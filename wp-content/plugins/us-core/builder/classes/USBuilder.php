...
if ( ! class_exists( 'USBuilder' ) ) {
	...
	final class USBuilder {
		...
		public function after_footer_action() {
			...
			<div class="usb-builder-hover">
				<div class="usb-builder-hover-panel">
					...
					<a class="usb-builder-hover-panel-edit" href="javascript:void(0)" target="_blank"></a>
		 ...
		 */
		public function page_component( $atts, $post_id ) {
			...
			else if ( strpos( $current_filter, 'us_footer' ) === 0 ) {
		...
		public function init_builder_page() {
			...
			$usb_settings += array(
				...
				'outside_elms' => us_config( 'us-builder.outside_elms', array() ),

				// Determining if a license is activated
				'is_activated' => (
					get_option( 'us_license_activated', /* default */0 )
