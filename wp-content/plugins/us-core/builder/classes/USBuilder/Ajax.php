...
final class USBuilder_Ajax {
	...
	public static function get_templates_config() {
		...
		$get_variables = array(
			...
			'secret' => get_option( 'us_license_secret' ),
		);

		// Get template configurations
		$us_api_response = us_api( '/templates_config/:us_themename', $get_variables, /* return as array */TRUE );
	...
	private static function get_template_category( $template_category_id ) {
		...
		$us_api_response = us_api( '/templates_content/:us_themename', $get_variables, /* return as array */TRUE );
