	...
	'general' => array(
		...
		'fields' => array(
			...
			'block_third_party_files' => array(
				...
				'title_pos' => 'side',
				'type' => 'switch',
				'switch_text' => __( 'Block loading of third-party files until the consent of site visitor', 'us' ),
				'description' => __( 'When this option is ON, the Map element will not load related third-party script files until site visitor consents.', 'us' ),
				'std' => 0,
				'classes' => 'desc_3',
			),
		),
	...
	'advanced' => array(
		...
		'fields' => array(
			...
			'og_enabled' => array(
				...
				'description' => __( 'If you\'re using any SEO plugin, turn OFF this option to avoid conflicts.', 'us' ) . ' <a href="' . $help_portal_url . '/' . strtolower( US_THEMENAME ) . '/general/seo/" target="_blank">' . __( 'Learn more', 'us' ) . '</a>',
				'std' => 1,
