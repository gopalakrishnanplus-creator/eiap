...
return array(
	...
	// Content Description
	'content_description' => sprintf( __( 'Add or edit a Page Template on the %s page', 'us' ), '<a href="' . admin_url( 'edit.php?post_type=us_content_template' ) . '" target="_blank" rel="noopener">' . __( 'Page Templates', 'us' ) . '</a>' ),

	// Footer Description
	'footers_description' => sprintf( __( 'Add or edit a Footer on the %s page', 'us' ), '<a href="' . admin_url( 'edit.php?post_type=us_page_block' ) . '" target="_blank" rel="noopener">' . __( 'Reusable Blocks', 'us' ) . '</a>' ),
