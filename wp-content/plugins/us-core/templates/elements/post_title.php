...
// Never display a Post title, when it's being output as shortcode inside of grid via Post Content element
global $us_grid_outputs_items;
if ( ! empty( $us_grid_outputs_items ) AND $us_elm_context == 'shortcode' ) {
	return;
}
