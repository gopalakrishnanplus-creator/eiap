...
if ( ! empty( $link_atts['href'] ) OR usb_is_preview_page() ) {
...
$output_front_title = '';
if ( ! empty( $front_title ) OR usb_is_preview_page() ) {
...
$output_front_desc = '';
if ( ! empty( $front_desc ) OR usb_is_preview_page() ) {
...
if ( ! us_amp() ) {
	...
	if ( ! empty( $back_title ) OR usb_is_preview_page() ) {
	...
	if ( ! empty( $back_desc ) OR usb_is_preview_page() ) {
