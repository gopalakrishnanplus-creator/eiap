...
<div id="comments" class="w-comments">
	...
	<?php if ( comments_open() ) {
		if ( get_option( 'comment_registration' ) AND ! is_user_logged_in() ) {
			...
			$comment_form_args['submit_button'] = '<button type="submit" class="w-btn us-btn-style_' . $btn_style . '"><span class="w-btn-label">' . us_translate( 'Post Comment' ) . '</span></button>';
...
<style>.comment-form-field.comment-form-url,.w-form-row.for_email {
