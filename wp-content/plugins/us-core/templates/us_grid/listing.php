 ...
 */
global $us_is_page_block_in_menu, $us_is_page_block_in_no_results, $us_grid_no_results;

$us_grid_no_results = array(
	'action' => isset( $no_items_action ) ? $no_items_action : 'message',
	'message' => isset( $no_items_message ) ? $no_items_message : us_translate( 'No results found.' ),
	'page_block' => isset( $no_items_page_block ) ? $no_items_page_block : '',
);
