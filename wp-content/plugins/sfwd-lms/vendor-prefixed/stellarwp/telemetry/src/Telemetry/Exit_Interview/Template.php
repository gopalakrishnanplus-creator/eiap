...
namespace StellarWP\Learndash\StellarWP\Telemetry\Exit_Interview;
...
use StellarWP\Learndash\StellarWP\Telemetry\Contracts\Template_Interface;
use StellarWP\Learndash\StellarWP\Telemetry\Core;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @param \StellarWP\Learndash\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
