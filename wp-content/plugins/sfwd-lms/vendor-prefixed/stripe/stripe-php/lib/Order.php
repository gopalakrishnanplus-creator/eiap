 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Charge $charge The ID of the payment used to pay for the order. Present if the order status is <code>paid</code>, <code>fulfilled</code>, or <code>refunded</code>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string|\StellarWP\Learndash\Stripe\Customer $customer The customer used for the order.
 ...
 * @property \StellarWP\Learndash\Stripe\OrderItem[] $items List of items constituting the order. An order can have up to 25 items.
 ...
 * @property null|\StellarWP\Learndash\Stripe\Collection<\Stripe\OrderReturn> $returns A list of returns that have taken place for this order.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping The shipping address for the order. Present if the order is for goods to be shipped.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject[] $shipping_methods A list of supported shipping methods for this order. The desired shipping method can be specified either by updating the order, or when paying it.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $status_transitions The timestamps at which the order status was updated.
...
class Order extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\OrderReturn the newly created return
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Order the paid order
     */
