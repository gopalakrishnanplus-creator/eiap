 ...
 * @property null|\StellarWP\Learndash\Stripe\BankAccount $active_account Hash describing the current account on the recipient, if there is one.
 * @property null|\StellarWP\Learndash\Stripe\Collection<\Stripe\Card> $cards
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string|\StellarWP\Learndash\Stripe\Card $default_card The default card to use for creating transfers to this recipient.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Account $migrated_to The ID of the <a href="https://stripe.com/docs/connect/custom-accounts">Custom account</a> this recipient was migrated to. If set, the recipient can no longer be updated, nor can transfers be made to it: use the Custom account instead.
 * @property null|string $name Full, legal name of the recipient.
 * @property string|\StellarWP\Learndash\Stripe\Account $rolled_back_from
