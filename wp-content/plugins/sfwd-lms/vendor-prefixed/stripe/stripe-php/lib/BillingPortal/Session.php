 ...
 * @property string|\StellarWP\Learndash\Stripe\BillingPortal\Configuration $configuration The configuration used by this session, describing the features available.
