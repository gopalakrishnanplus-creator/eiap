...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @throws \StellarWP\Learndash\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\EphemeralKey the created key
     */
