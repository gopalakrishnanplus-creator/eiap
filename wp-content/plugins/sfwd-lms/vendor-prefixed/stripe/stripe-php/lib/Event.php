 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $data
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $request Information on the API request that instigated the event.
