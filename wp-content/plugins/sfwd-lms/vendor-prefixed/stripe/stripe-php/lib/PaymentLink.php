 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $after_completion
 ...
 * @property \StellarWP\Learndash\Stripe\Collection<\Stripe\LineItem> $line_items The line items representing what is being sold.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
...
class PaymentLink extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\Stripe\PaymentLink> list of LineItems
     */
