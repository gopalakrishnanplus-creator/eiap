 ...
 * @property string|\StellarWP\Learndash\Stripe\Product $product The ID of the product this price is associated with.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
...
class Price extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\SearchResult<Price> the price search results
     */
