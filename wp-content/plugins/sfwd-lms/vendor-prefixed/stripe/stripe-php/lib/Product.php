 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Price $default_price The ID of the <a href="https://stripe.com/docs/api/prices">Price</a> object that is the default price for this product.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID.
...
class Product extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\SearchResult<Product> the product search results
     */
