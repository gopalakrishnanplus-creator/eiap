 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Charge $charge The charge associated with this review.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property string|\StellarWP\Learndash\Stripe\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
...
class Review extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Review the approved review
     */
