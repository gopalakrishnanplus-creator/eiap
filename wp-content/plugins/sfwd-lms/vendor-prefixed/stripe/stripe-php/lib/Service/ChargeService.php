...
class ChargeService extends \StellarWP\Learndash\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\Stripe\Charge>
     *
     * @license MIT
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Charge
     */
     ...
     * will occur as if in live mode. (StellarWP\Learndash\Stripe assumes that the charge would have
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\SearchResult<\Stripe\Charge>
     */
