...
class OAuthService extends \StellarWP\Learndash\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StellarWP\Learndash\Stripe\StripeObject the object returned by Stripe's Connect API
     */
    ...
    private function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $msg = 'No client_id provided. (HINT: set your client_id using '
              . '`new \StellarWP\Learndash\Stripe\StripeClient([clientId => <CLIENT-ID>
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Util\RequestOptions
     */
    private function _parseOpts($opts)
    {
        if (\is_array($opts)) {
            if (\array_key_exists('connect_base', $opts)) {
                ...
                throw new \StellarWP\Learndash\Stripe\Exception\InvalidArgumentException('Use `api_base`, not `connect_base`');
            }
        }

        return \StellarWP\Learndash\Stripe\Util\RequestOptions::parse($opts);
    }
