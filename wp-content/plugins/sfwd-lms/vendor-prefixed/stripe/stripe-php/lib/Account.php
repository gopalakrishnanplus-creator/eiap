 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \StellarWP\Learndash\Stripe\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \StellarWP\Learndash\Stripe\StripeObject $company
 * @property \StellarWP\Learndash\Stripe\StripeObject $controller
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $tos_acceptance
...
class Account extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Account
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\StripeObject object containing the response from the API
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Account the rejected account
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Capability
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\BankAccount|\StellarWP\Learndash\Stripe\Card
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\LoginLink
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Person
     */
