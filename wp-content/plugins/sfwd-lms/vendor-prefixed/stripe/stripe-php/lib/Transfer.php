 ...
 * @property null|string|\StellarWP\Learndash\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Account $destination ID of the Stripe account the transfer was sent to.
 * @property string|\StellarWP\Learndash\Stripe\Charge $destination_payment If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \StellarWP\Learndash\Stripe\Collection<\Stripe\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Transfer the canceled transfer
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\Stripe\TransferReversal> the list of transfer reversals
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\TransferReversal
     */
