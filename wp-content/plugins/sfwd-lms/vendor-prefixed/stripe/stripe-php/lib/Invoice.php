 ...
 * @property null|(string|\StellarWP\Learndash\Stripe\TaxId)[] $account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\StripeObject $application ID of the Connect Application that created the invoice.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject[] $custom_fields Custom fields displayed on the invoice.
 * @property null|string|\StellarWP\Learndash\Stripe\Customer $customer The ID of the customer who will be billed.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\StellarWP\Learndash\Stripe\Account|\StellarWP\Learndash\Stripe\AlipayAccount|\StellarWP\Learndash\Stripe\BankAccount|\StellarWP\Learndash\Stripe\BitcoinReceiver|\StellarWP\Learndash\Stripe\Card|\StellarWP\Learndash\Stripe\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property \StellarWP\Learndash\Stripe\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\StellarWP\Learndash\Stripe\Discount $discount Describes the current discount applied to this invoice, if there is one. Not populated if there are multiple discounts.
 * @property null|(string|\StellarWP\Learndash\Stripe\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\StellarWP\Learndash\Stripe\ErrorObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property \StellarWP\Learndash\Stripe\Collection<\StellarWP\Learndash\Stripe\InvoiceLineItem> $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 * @property \StellarWP\Learndash\Stripe\StripeObject $payment_settings
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Quote $quote The quote this invoice was generated from.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Subscription $subscription The subscription that this invoice was prepared for, if any.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice belongs to.
 * @property \StellarWP\Learndash\Stripe\StripeObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject[] $total_discount_amounts The aggregate amounts calculated per discount across all line items.
 * @property \StellarWP\Learndash\Stripe\StripeObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\StellarWP\Learndash\Stripe\InvoiceLineItem> the list of lines (InvoiceLineItem)
     */
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Invoice the finalized invoice
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Invoice the uncollectible invoice
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Invoice the paid invoice
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Invoice the sent invoice
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Invoice the upcoming invoice
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Invoice the voided invoice
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\SearchResult<Invoice> the invoice search results
     */
