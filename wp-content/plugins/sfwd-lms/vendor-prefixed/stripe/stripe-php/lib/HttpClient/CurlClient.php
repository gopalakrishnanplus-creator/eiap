...
use StellarWP\Learndash\Stripe\Exception;
use StellarWP\Learndash\Stripe\Stripe;
use StellarWP\Learndash\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \StellarWP\Learndash\Stripe\Util\RandomGenerator */
     ...
     * @param null|\StellarWP\Learndash\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\StellarWP\Learndash\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
