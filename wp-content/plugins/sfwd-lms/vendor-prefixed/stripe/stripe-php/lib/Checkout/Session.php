...
namespace StellarWP\Learndash\Stripe\Checkout;
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only present on Sessions in <code>payment</code> or <code>subscription</code> mode.
 ...
 * @property \StellarWP\Learndash\Stripe\Collection<\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $phone_number_collection
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string|\StellarWP\Learndash\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property \StellarWP\Learndash\Stripe\StripeObject[] $shipping_options The shipping rate options applied to this Session.
 * @property null|string|\StellarWP\Learndash\Stripe\ShippingRate $shipping_rate The ID of the ShippingRate for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
...
class Session extends \StellarWP\Learndash\Stripe\ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Checkout\Session the expired session
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\Stripe\LineItem> the list of items
     */
