 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $amount_details
 * @property int $amount_received Amount that was collected by this PaymentIntent.
 * @property null|string|\StellarWP\Learndash\Stripe\StripeObject $application ID of the Connect application that created the PaymentIntent.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $automatic_payment_methods Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe Dashboard</a>
 ...
 * @property \StellarWP\Learndash\Stripe\Collection<\Stripe\Charge> $charges Charges that were created by this PaymentIntent, if any.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Invoice $invoice ID of the invoice that created this PaymentIntent, if it exists.
 * @property null|\StellarWP\Learndash\Stripe\ErrorObject $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 * @property null|string|\StellarWP\Learndash\Stripe\Account $on_behalf_of The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentMethod $payment_method ID of the payment method used in this PaymentIntent.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 * @property string[] $payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $processing If present, this property tells you about the processing state of the payment.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Review $review ID of the review associated with this PaymentIntent, if any.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping Shipping information for this PaymentIntent.
 * @property null|string|\StellarWP\Learndash\Stripe\Account|\StellarWP\Learndash\Stripe\AlipayAccount|\StellarWP\Learndash\Stripe\BankAccount|\StellarWP\Learndash\Stripe\BitcoinReceiver|\StellarWP\Learndash\Stripe\Card|\StellarWP\Learndash\Stripe\Source $source This is a legacy field that will be removed in the future. It is the ID of the Source object that is associated with this PaymentIntent, if one was supplied.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $transfer_data The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
...
class PaymentIntent extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\PaymentIntent the applied payment intent
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\PaymentIntent the canceled payment intent
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\PaymentIntent the captured payment intent
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\PaymentIntent the confirmed payment intent
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\PaymentIntent the incremented payment intent
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\PaymentIntent the verified payment intent
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\SearchResult<PaymentIntent> the payment intent search results
     */
