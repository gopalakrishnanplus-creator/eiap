 ...
 * @property string|\StellarWP\Learndash\Stripe\Account $account ID of the Stripe account this fee was taken from.
 ...
 * @property string|\StellarWP\Learndash\Stripe\StripeObject $application ID of the Connect application that earned the fee.
 * @property null|string|\StellarWP\Learndash\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this collected application fee on your account balance (not including refunds).
 * @property string|\StellarWP\Learndash\Stripe\Charge $charge ID of the charge that the application fee was taken from.
 ...
 * @property \StellarWP\Learndash\Stripe\Collection<\Stripe\StripeObject> $refunds A list of refunds that have been applied to the fee.
 *
 * @license MIT
...
class ApplicationFee extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\Stripe\ApplicationFeeRefund> the list of fee refunds
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\ApplicationFeeRefund
     */
