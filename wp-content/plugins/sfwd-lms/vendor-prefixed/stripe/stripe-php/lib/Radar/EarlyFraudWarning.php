 ...
 * @property string|\StellarWP\Learndash\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property string|\StellarWP\Learndash\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 *
 * @license MIT
