 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
