 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $billing_thresholds Define thresholds at which an invoice will be sent, and the related subscription advanced to a new billing period
...
class SubscriptionItem extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\UsageRecord
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Collection the list of usage record summaries
     */
