 ...
 * @property null|string|\StellarWP\Learndash\Stripe\StripeObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\StellarWP\Learndash\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \StellarWP\Learndash\Stripe\StripeObject $default_settings
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
...
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\SubscriptionSchedule the released subscription schedule
     */
