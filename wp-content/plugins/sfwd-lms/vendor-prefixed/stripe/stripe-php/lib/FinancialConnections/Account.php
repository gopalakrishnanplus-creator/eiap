 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
...
class Account extends \StellarWP\Learndash\Stripe\ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\FinancialConnections\Account the refreshed account
     */
