 ...
 * @property \StellarWP\Learndash\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe account as a result of this dispute.
 * @property string|\StellarWP\Learndash\Stripe\Charge $charge ID of the charge that was disputed.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property \StellarWP\Learndash\Stripe\StripeObject $evidence
 * @property \StellarWP\Learndash\Stripe\StripeObject $evidence_details
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that was disputed.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Dispute the closed dispute
     */
