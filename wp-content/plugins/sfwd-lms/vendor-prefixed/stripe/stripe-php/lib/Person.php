 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \StellarWP\Learndash\Stripe\StripeObject $dob
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $registered_address
 * @property \StellarWP\Learndash\Stripe\StripeObject $relationship
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $verification
 *
 * @license MIT
