 ...
 * @property null|string|\StellarWP\Learndash\Stripe\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this top-up on your account balance. May not be specified depending on status of top-up.
...
class Topup extends ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Topup the canceled topup
     */
