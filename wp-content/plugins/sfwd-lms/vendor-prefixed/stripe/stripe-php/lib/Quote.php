 ...
 * @property null|string|\StellarWP\Learndash\Stripe\StripeObject $application ID of the Connect Application that created the quote.
 ...
 * @property (string|\StellarWP\Learndash\Stripe\TaxRate)[] $default_tax_rates The tax rates applied to this quote.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $invoice_settings All invoices will be billed using the specified settings.
 * @property \StellarWP\Learndash\Stripe\Collection<\Stripe\LineItem> $line_items A list of items the customer is being quoted for.
...
class Quote extends ApiResource
{
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\Collection<\Stripe\Quote> list of LineItems
     */
