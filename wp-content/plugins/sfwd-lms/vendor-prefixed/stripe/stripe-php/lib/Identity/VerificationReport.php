 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject $document Result from a document check
 * @property \StellarWP\Learndash\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \StellarWP\Learndash\Stripe\StripeObject $options
 * @property \StellarWP\Learndash\Stripe\StripeObject $selfie Result from a selfie check
